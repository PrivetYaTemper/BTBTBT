...
// Do not delete these lines
	...
	if ( post_password_required() ) { ?>
		<p class="nocomments">Запись защищена паролем. Введите пароль для просмотра комментариев.</p>
	<?php
		return;
	}
?>
...
<h3><?php comment_form_title( 'Добавить комментарий', 'Ответить %s' ); ?></h3>
...
<label for="email"><small>E-mail <?php if ($req) echo "(обязательно)"; ?></small></label></p>
